...
class SW(object):
    ...
    def csv_writer(self, filename, pd):
        """ write to a CSV file"""
        pd.to_csv(filename, sep='\lt', index=False, encoding='utf-8')
    ...
    def modify_data(self, df, i, j, param):
        pass
...
if __name__ == '__main__':
    ...
    #h,k = a.csv_reader('2b.csv')
    #a.csv_writer('test.csv',h, k)
    #a.lammps_input_writer('test.sw')
    #a.constants_reader('constants.yml')
